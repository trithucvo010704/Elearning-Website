...
CREATE TABLE IF NOT EXISTS payments (
    ...
    currency                VARCHAR(10) NOT NULL DEFAULT 'USD',
    provider                ENUM('STRIPE','VNPAY') NOT NULL DEFAULT 'STRIPE',
    method                  VARCHAR(64) NULL,
    refunded_amount_cents   INT NOT NULL DEFAULT 0,
    status                  ENUM('REQUIRES_PAYMENT','PAID','FAILED','REFUNDED','PENDING','SUCCESS') NOT NULL,
    vnp_txn_ref             VARCHAR(64) NULL,
    vnp_transaction_no      VARCHAR(64) NULL,
    vnp_response_code       VARCHAR(16) NULL,
    vnp_bank_code           VARCHAR(32) NULL,
...
-- Role: INSTRUCTOR
-- BCrypt hash for "Instructor123!" (generated with cost factor 10)
INSERT INTO users (username, password_hash, full_name, role, enabled, created_at, updated_at)
VALUES (
    'instructor_demo',
