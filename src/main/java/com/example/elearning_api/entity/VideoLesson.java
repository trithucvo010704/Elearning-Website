...
@Table( // cấu hình bảng
                ...
                uniqueConstraints = { @UniqueConstraint(name = "uq_lesson_course_order", columnNames = { "course_id",
                                "order_index" }) }, // unique theo course + thứ tự
                indexes = {
                                @Index(name = "idx_lessons_course", columnList = "course_id, id"), // index tra cứu theo
                                                                                                   // khóa học
                                @Index(name = "idx_lessons_course_order", columnList = "course_id, order_index")// index
                                                                                                                // cho
                                                                                                                // sắp
                                                                                                                // xếp
                })
